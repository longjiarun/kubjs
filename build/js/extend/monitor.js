...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (factory) {
	    ...
	    function Monitor(opts) {
	        ...
	        var defaults = Monitor.prototype.defaults,
	            options = {};
	        if (opts) {
	    ...
	    Monitor.prototype = {
	        ...
	        defaults: {
	            ...
	            validateVar: function validateVar() {
	        ...
	        _init: function _init() {
	            ...
	            if (self.isValidate()) {
	                var _handleError = function _handleError() {
	                    ...
	                    _handleDOMContentLoaded = function _handleDOMContentLoaded() {
	                    if (self && self.isError && (!self.validateVar() || !self.validateScript())) {
	         ...
	         */
	        isSafeDomain: function isSafeDomain(src) {
	            var self = this;
