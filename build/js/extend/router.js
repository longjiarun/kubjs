	...
	!function (factory) {
	    ...
	    ;(function () {
	        ...
	        this.navigate = function (route, opts) {
	            ...
	            if (!options.beforeRouteChange || self.currentRoute == void 0 || options.beforeRouteChange.call(self, route) !== false) {
	                ...
	                f && opts.trigger ? options.defaultRoute && location.replace(self.updateHash(location.href, options.defaultRoute)) : opts.updateHash && self._updateHash(route, opts.replace);
	            }
	            return self;
	        };
