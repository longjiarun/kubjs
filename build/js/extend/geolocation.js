...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (factory) {
	    var root = this,
	        Kub = root.Kub = root.Kub ? root.Kub : {};
	    if (typeof module !== "undefined" && module.exports) {
	        module.exports = factory(root, root.jQuery || root.Zepto, __webpack_require__(5));
	    } else if (true) {
	        !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    ...
	    Geolocation.prototype = {
	         ...
	         */
	        removeStoredAddress: function removeStoredAddress() {
	            var self = this,
	         ...
	         */
	        storeAddress: function storeAddress(address) {
	            var self = this,
	                options = self.options,
	         ...
	         * @return {Object} 地址信息
	         */
	        getStoredAddress: function getStoredAddress() {
	            var self = this,
	                options = self.options,
	         ...
	         * @return {instance} 当前实例
	         */
	        getCurrentPosition: function getCurrentPosition(success, _error, _options) {
	            var self = this,
	                options = self.options,
	                settings,
	                error;
	         ...
	         * @return {instance} 当前实例
	         */
	        getAddress: function getAddress(callback, error) {
	            var self = this,
	                options = self.options,
	                city,
	                timer,
	         ...
	         * @return {instance} 当前实例
	         */
	        getAddressByPosition: function getAddressByPosition(callback, error) {
	            var self = this,
	                options = self.options,
	                address,
	                timer,
	         ...
	         * @return {instance} 当前实例
	         */
	        getAddressByIp: function getAddressByIp(callback, error) {
	            var self = this,
	                options = self.options,
	                address,
