	...
	!function (factory) {
	    ...
	    (function () {
	        ...
	        function calculate(a, b) {
	            var _a,
	                _b,
	                r1 = this.getDecimalDigit(a),
	                r2 = this.getDecimalDigit(b),
	                d = r1 - r2,
	                _d = Math.pow(10, Math.abs(d)),
	        ...
	        var f = ["add", "sub", "mul", "div", "toFixed2"],
	            i = f.length,
	            proto = Calculator.prototype;
	        while (i--) {
	            (function (i) {
