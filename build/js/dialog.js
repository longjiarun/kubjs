!(function(root,factory){
    ...
    ;(function(){
        ...
        this.disableScrollbar = function(){
            !this.options.scrollable && $body.addClass(OVERFLOWCLASS) && $html.addClass(OVERFLOWCLASS) && i++;
            return this;
        };

        this.enableScrollbar = function(){
            !this.options.scrollable && i<1 && $body.removeClass(OVERFLOWCLASS) && $html.removeClass(OVERFLOWCLASS) && (i=0);
            return this;
        };
