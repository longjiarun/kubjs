...
/***/ function(module, exports, __webpack_require__) {
	...
	!function (factory) {
	    ...
	    if (typeof module !== "undefined" && module.exports) {
	        module.exports = factory(root, root.jQuery || root.Zepto, __webpack_require__(10));
	    } else if (true) {
	        !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    ...
	    var Swiper = function Swiper(element, options) {
	    ...
	    function init() {
	        ...
	        var hammer = new Hammer(self.$element[0]),
	            x,
	            y,
	            w,
	            h,
