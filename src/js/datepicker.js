...
proto._cacheData = function($this,index){
    $this[0].y = index * HEIGHTUNIT;
    $this[0].index = Math.abs(index);
    return this;
};

proto._registerGlobalScroll = function(){
    var self = this,
...
proto._getIndex = function(y,height,max){
    //去掉空白的两行
    max = max-3;
    y = y > 0 ? 0 : y;
...
proto.setTranslate = function($this,x,y,duration){
...
proto._setDays = function(year,month){
    var self = this,
...
proto.getDays = function(year,month){
