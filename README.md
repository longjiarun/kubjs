...
```
<link rel="stylesheet" type="text/css" href="//assets.geilicdn.com/v-components/kubjs/2.0.3/index.css">

<script type="text/javascript" src="//assets.geilicdn.com/v-components/kubjs/2.0.3/index.js"></script>

<script type="text/javascript" src="//assets.geilicdn.com/v-components/kubjs/2.0.3/index.style.js"></script>
```
...
[查看文档](http://h5.weidian.com/v-components/kubjs/docs/v2.0.3/kub.js.html)
