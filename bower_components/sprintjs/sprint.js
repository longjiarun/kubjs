...
(function() {
    ...
    var manipulateClass = function(method, className, bool) {
        ...
        return this.each(function(i, el) {
            ...
            for (var j = 0; j < classNamesLen; j++) {
                ...
                if (!name) continue
                bool == null ? el.classList[method](name) : el.classList.toggle(name, bool)
            }
        })
    }
    ...
    var sanitize = function(arr, flattenObjects, requireDomNodes) {
        ...
        while (i--) {
            ...
            if ((!arr[i] && arr[i] !== 0) || (flattenObjects && arr[i] instanceof Init) || (requireDomNodes && (typeof arr[i] == "string" || typeof arr[i] == "number"))) {
                var sanitized = []
    ...
    var scroll = (function() {
        ...
        return function(sprintObj, method, value) {
            ...
            if (!scrollRoot) {
                ...
                scrollRoot = updatedScrollPos > initialScrollPos ? root // spec-compliant browsers (like FF34 and IE11)
    ...
    var wrap = (function() {
        var callback = function(wrappingElement, variant) {
            ...
            if (variant == "inner") {
                ...
                variant == "all" ? this.each(function() {
        ...
        return function(wrappingElement, variant) {
            if (typeof wrappingElement == "function") {
                ...
                variant == "all" ? callback.call(this, wrappingElement, variant) : this.each(function() {
        ...
        offset: function(coordinates) {
            ...
            if (typeof coordinates == "object") {
                return this.each(function() {
                    ...
                    $this.css("position") == "static" ? $this.css("position", "relative") : $this.css({
                        top: 0,
                        left: 0
                    })
                    var pos = $this.offset()
